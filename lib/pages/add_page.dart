                  ...
                  child: Container(
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () async {
                        ...
                        brandController.text.isNotEmpty && titleController.text.isNotEmpty && typeController.text.isNotEmpty && priceController.text.isNotEmpty && _imageUrl != null && expiryDate != null ? await FirebaseFirestore.instance.collection("Markets").doc("${FirebaseAuth.instance.currentUser?.uid}").collection("typed").doc("names").collection("types").doc(typeController.text.toLowerCase()) : print("Fill the gaps");
