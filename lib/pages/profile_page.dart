            ...
            child: Column(
              ...
              children: <Widget>[
                Row(
                  ...
                  children: [
                    Padding(
                      ...
                      child: Text("22/05/2022", style: TextStyle(color: Colors.redAccent, fontSize: 20),),
                    ),
                  ],),
                ...
                Row(
                  ...
                  children: <Widget>[
                    Text(text, style: TextStyle(fontSize: 24, color: Colors.redAccent),
                    )],
                ),
          ...
          Padding(
            ...
            child: TextField(
              ...
              decoration: InputDecoration(
                ...
                labelText: "Ad Soyad",
                suffixIcon: IconButton(icon: _isEditOn ? Icon(Icons.edit, color: Colors.redAccent,) : Icon(Icons.done, color: Colors.redAccent,),
                  onPressed: (){
                    setState(() {
                      _toggle();
          ...
          Padding(
            ...
            child: TextField(
              ...
              decoration: InputDecoration(
                ...
                prefixIconColor: Colors.redAccent,
                suffixIcon: IconButton(icon: _isEditOn2 ? Icon(Icons.edit, color: Colors.redAccent,) : Icon(Icons.done, color: Colors.redAccent,), onPressed: _toggle2,),
